        ...
        <section id="skills" className="py-10 bg-gray-800 relative">
            <div className="mt-8 text-gray-100 text-center">
                <h3 className="text-3xl font-semibold">
                    My <span className="text-cyan-600">Skillls</span>
                </h3>
                ...
                <div className="flex items-center justify-center gap-10 mt-12 flex-wrap">
                    {
                        skills?.map((skill, i) => (
                            <div key={i} className="border-2 group border-cyan-600 relative min-w-[10rem] max-w-[16rem] bg-gray-900 p-10 rounded-xl">
                                <div style={{background : `conic-gradient(rgb(8,145,170) ${skill.count}%, #ddd ${skill.count}%`}} className="w-32 h-32 rounded-full flex items-center justify-center">
                                    <div className="text-6xl w-28 h-28 flex group-hover:text-cyan-600 items-center justify-center bg-gray-900 rounded-full">
